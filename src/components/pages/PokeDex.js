...
function PokeDex() {
  ...
  }, [search, searchApiFetch, currentPokemonList]);
  ...
  {/*const onClickReverse =  () => {
    const sorted = pokemons.sort((a, b) => b.id - a.id);
    setPokemonApi(sorted)
  } */}
      ...
      <header className="App-header">
        {isLoading ? (
          ...
          <>
            ...
            {/*<button className="button" title="Sort" onClick={onClickReverse}/>*/}
            {notfound && (
